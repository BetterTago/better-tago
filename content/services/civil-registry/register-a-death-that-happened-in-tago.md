...
The charter answers _"How do I register a death?"_ in more than one place, and this project has not merged those entries into one page.

Two charter entries, and the charter does not say what separates them. Both are kept: merging them would mean choosing one set of requirements for a resident and dropping the other.
...
That is recorded rather than resolved. Guessing which reading is right would be this project inventing a fact the municipality never published.
