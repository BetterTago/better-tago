...
> REQUEST FOR TOURISM FRONTLINERS TRAINING
...
| --- | --- |
| 1. Letter of Request | Requisitioning Agency |
| 2. Endorsement from the LCE | Mayor’s Office |

**Client steps**

| Client steps | Agency action | Fees to be paid | Processing time | Person responsible |
| --- | --- | --- | --- | --- |
| Go to Information Section and Submit Receive and Review Letter of Letter of Intent Intent | Tourism Office Staff |  | 15 Minutes |  |
| Interview and Review of Request for DOT Endorsement | Tourism Officer |  | 10 Minutes |  |
| Approve Endorsement | Municipal Mayor | None | 5 Minutes |  |
| Record and Release requested document Receive Endorsement Letter | Tourism Office Staff |  |  |  |
| **TOTAL** | | **None** | **5 Minutes 35 Minutes** | |
