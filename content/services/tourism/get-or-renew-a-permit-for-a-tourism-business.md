...
**Who provides it:** Tourism Office, Tago Municipal Hall.
...
| Who may Avail | Tourism Sector |

**Checklist of requirements**

| Checklist of requirements | Where to secure |
| --- | --- |
| 1. Documentary requirement | Requisitioning Agency |
| 2. Tourism Compliance Certificate | Tourism Office |

**Client steps**

| Client steps | Agency action | Fees to be paid | Processing time | Person responsible |
| --- | --- | --- | --- | --- |
| Go to information section then present and submit the documentary requirements | Receive and Encode data |  | 15 Minutes | Tourism Office Staff |
|  | Review of data and printing of Tourism Compliance Certificate | None | 10 Minutes | Tourism Office Staff |
|  | Approve, Sign and release Tourism Compliance Certificate (TCC) |  | 5 Minutes | Tourism Officer |
| Received Approved Tourism Compliance Certificate | Record and Release of Tourism Compliance Certificate |  | 5 Minutes | Tourism Office Staff |
...
- [Tourism Office](https://tago.gov.ph/wp-content/uploads/2024/12/Tourism-External-Services.pdf) — the Citizen’s Charter for this office, retrieved 2026-08-09
- [Read the whole document, transcribed](/en/charter/documents/tourism-external-services)
