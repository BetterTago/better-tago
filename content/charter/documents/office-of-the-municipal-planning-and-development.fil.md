...
**Pinagmulan:** [Office of the Municipal Planning and Development](https://tago.gov.ph/wp-content/uploads/2024/12/Office-of-the-Municipal-Planning-and-Development.pdf) · 2 serbisyo · kinuha noong 9 Agosto 2026 · `sha256:4962c64ba552ccf9…`

## Mga panlabas na serbisyo — 2

### 1. Issuance of Zoning Certification

- → [Get a zoning certification](/fil/services/engineering/get-a-zoning-certification)
...
| --- | --- |
| 1. Proof of Ownership or Right over the property Certified True Copy of Transfer Certificate of Title If in case not registered in the name of applicant: - Deed of Absolute Sale | — |
| - Affidavit of Consent from the Lot Owner | — |
| - Deed of Donation | — |
| - Contract to Sell | — |
| 2. Photocopy of Latest Tax Declaration | — |
| 3. Photocopy of Tax Clearance/ Latest Tax Receipt | — |
| 4. Barangay Clearance | — |
| 5. One Long Envelope for filing | — |
| 6. Additional Requirements if prior to issuance of Building permit (one copy per document): | — |
| • Bill of Materials and Cost Estimates | — |
| • Building Plan / Fencing Plan | — |
| • For house with 30sq. meter or less: house plan drawn in a long bond paper with vicinity map and electrical lay-out | — |
| 7. Additional Requirements if Land Classification only (one copy per document): | — |
| • Duly accomplished / notarized application for zoning certification | — |
| • Lot Plan drawn to a minimum scale of 1:100 meters with Vicinity Map drawn and duly signed by a Licensed Geodetic Engineer | — |

**Saan kukunin**, ayon sa pagkakalimbag ng charter — sa tabi ng buong listahan at hindi sa bawat item:

- CTC at Registry of Deeds, Capitol Hills, Tandag City
- Notary Public Notary Public Notary Public
- Municipal Assessor’s Office
- Municipal Treasurer’s Office
- Barangay Hall where the project is located
- Licensed Architect or Civil Engineer Licensed Architect or Civil Engineer Project owner and Professional Electrical Engineer
- MPDO- Zoning Division/ and Public Notary
...
| --- | --- | --- | --- | --- |
| 1. Log- in the client’s information | 1.1 Require the client to record the name, address, contact number and purpose using logbook; and hand-in feedback form | None | 1 Minute |  |
| 2. Submit requirements • Inquire for requirements necessary for the application; • Comply documents required for application; • Fill-up application form | 2.1 Provide checklist of the requirements needed for the application | None | 2 Minutes | Zoning Officer / Receiving Clerk |
|  | 2.2 Check the requirements as to completeness | None | 2 Minutes |  |
| • Assessment for the schedule of fees | 2.3 Provide an application form to be filled up and notarize | None | 1 Minute |  |
|  | 2.4 Assess fees based on the cost estimates of project for order of payment | None | 2 minutes |  |
| 3. Evaluate documents • Review the application | 3.1 Check and validate the completeness and correctness of the requirements and the assessment of fees | None | 10 Minutes | Zoning Officer / PDO II |
| • Review the assessed schedule of fees |  | None | 2 Minutes |  |
|  | 3.2 Review and advise to pay at the Treasurer’s Office |  |  |  |
| 4. Payment of fees | 4.1 Check the issued official receipt by the MTO | Fees based on the project cost | 5 minutes (depends as to the number of clients) | MT Officer/ Cashier |
| 5. Schedule Site Inspection • Submission of requirements with official receipt • Schedule date of site inspection | 5.1 Receive the requirements with copy of OR and get the contact number 5.2 Conduct ocular inspection of the project site | None None | 1 Minute 30 Minutes (per application) | Zoning Officer Receiving – Releasing Clerk Zoning Officer |
| 6. Record the Inspected Application in the system |  | None | 5 Minutes | Zoning Officer / PDO II / Receiving- Releasing Clerk Zoning Officer / PDO II |
| 7. Final Review of the application | 6.1 In-put the application details in the system (with its corresponding application code) 7.1 Conduct final review of the application | None | 5 Minutes |  |
| 8. Printing of Certification | 8.1 Print the certification | None | 1 Minute |  |
| 9. Approval of the Certification | 9.1 Review and sign the certification for approval | None | 1 Minute | Zoning Officer / PDO II/ Receiving – Releasing Clerk Zoning Officer / PDO II & MPDC/ LCE Zoning Officer / PDO II Receiving – Releasing Clerk |
| 10. Releasing of Approved Zoning Certification | 10.1 Notify the applicant thru text or call for the releasing of the approved application/ certification | None | 2 Minutes |  |
| 11. Claiming of Approved Certification | 11.1 Release and record the approved certification in the log-book | None | 2 Minutes | Zoning Officer / PDO II Receiving – Releasing Clerk Clerk |
| 12. Feedback form retrieval | 12.1 Retrieve the feedback form given to the client/applicant | None | 1 Minute |  |
|  | TOTAL | Total fee is based on Project Cost | 1 hr. and 13 minutes |  |

### 2. Issuance of Locational Clearance

- → [Get a locational clearance](/fil/services/engineering/get-a-locational-clearance)
